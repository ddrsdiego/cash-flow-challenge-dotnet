...
/// <summary>
/// Scoped implementation of ITransactionalPublisher.
...
/// </summary>
public sealed class MassTransitPublisher : ITransactionalPublisher, IDisposable
{
    private readonly IMongoClient _mongoClient;
    private readonly IPublishEndpoint _publishEndpoint;
    private IClientSessionHandle _session;

    public MassTransitPublisher(IMongoClient mongoClient, IPublishEndpoint publishEndpoint)
    {
