...
│   │   ├── Domain/
│   │   │   ├── Entities/          # Transaction, DailyConsolidation
│   │   │   └── Enums/             # TransactionType, Category
│   │   ├── Messages/              # TransactionCreatedEvent (MassTransit)
│   │   ├── DTOs/
│   │   │   ├── Requests/          # CreateTransactionRequest
│   │   │   └── Responses/         # TransactionResponse, DailyConsolidationResponse, PagedResult
│   │   └── Interfaces/            # ITransactionRepository, IConsolidationRepository,
│   │                              # IConsolidationCache, ICacheInvalidator, ITransactionalPublisher
│   │
...
| **Fase 4.3** | Consolidation Worker | 🔄 Planejado |
